...
SCHEMA = "rsp-v6.1-control-profile/v1"
...
def verify(execution_zip: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "simulation_statement": (
            "For the certified source and every admitted input, alpha(Exec_CPython_3_11(S)) "
            "is a subset of Trace_RSP_V6_1(S)."
        ),
        "binding": {
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Recompute the RSP-V6.1 control-flow and source-binding profile."
    )
