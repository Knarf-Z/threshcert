...
const aggregate = {
  ...
  cohort: {
    ...
    pinnedBlockTimestamp: cohort.pinnedBlockTimestamp,
    recordedAt: cohort.recordedAt,
    registrationStatus: cohort.registrationStatus,
    firstPublicCommit: cohort.firstPublicCommit,
    subjectCount: rows.length,
    selectionRule: cohort.selectionRule,
    selectionNote: cohort.selectionNote,
  },
  interpretation: {
    sampling: "Fixed author-selected purposive stress cohort; it was not independently preregistered, post-selection bias cannot be excluded, and no prevalence estimate is claimed.",
