...
console.log("ARCHIVAL_DRIVER=includes exploratory and withdrawn modules not used by the v47 paper");
...
console.log("EXPLORATORY_NOT_USED_BY_V47=chiado_public_runs");
...
console.log("EXPLORATORY_NOT_USED_BY_V47=third_party_contract_survey");
...
console.log("ARCHIVAL_FORMULA_FAMILIES_NOT_USED_BY_V47=begin");
for (const script of [
  "test_equivalence.py",
