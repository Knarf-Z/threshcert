...
console.log("ARCHIVAL_DRIVER=includes exploratory and withdrawn modules not used by the v46 paper");
...
console.log("EXPLORATORY_NOT_USED_BY_V46=chiado_public_runs");
...
console.log("EXPLORATORY_NOT_USED_BY_V46=third_party_contract_survey");
...
console.log("ARCHIVAL_FORMULA_FAMILIES_NOT_USED_BY_V46=begin");
for (const script of [
  "test_equivalence.py",
