...
console.log("ARCHIVAL_DRIVER=includes exploratory and withdrawn modules not used by the v48 paper");
...
console.log("EXPLORATORY_NOT_USED_BY_V48=chiado_public_runs");
...
console.log("EXPLORATORY_NOT_USED_BY_V48=third_party_contract_survey");
...
console.log("ARCHIVAL_FORMULA_FAMILIES_NOT_USED_BY_V48=begin");
for (const script of [
  "test_equivalence.py",
